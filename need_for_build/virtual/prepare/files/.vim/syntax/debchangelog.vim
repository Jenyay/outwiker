...
syn match debchangelogTarget	contained "\v %(frozen|unstable|%(testing|%(old)=stable)%(-proposed-updates|-security)=|experimental|%(lenny|squeeze)-%(backports%(-sloppy)=|volatile)|%(dapper|hardy|jaunty|karmic|lucid|maverick|natty|oneiric|lucid|precise|quantal|raring|saucy|trusty|utopic|vivid|wily)%(-%(security|proposed|updates|backports|commercial|partner))=)+"
