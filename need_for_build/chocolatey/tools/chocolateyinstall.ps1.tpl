...
$fileLocation = Join-Path $toolsDir 'outwiker_win_unstable.exe'
...
$packageArgs = @{
  ...
  softwareName  = 'outwiker*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
...
## - https://chocolatey.org/docs/helpers-install-chocolatey-install-package
#Install-ChocolateyInstallPackage $packageName $fileType $silentArgs 'tools\outwiker_win_unstable.exe' -validExitCodes $validExitCodes
