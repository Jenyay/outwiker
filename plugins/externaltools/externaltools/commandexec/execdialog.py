...
class ExecDialog(TestedDialog):
    def __init__(self, parent):
        ...
        self._formats = [_("Link"), _("Button")]

        self.SetTitle(_("Inserting (:exec:) command"))
        self._createGui()
    ...
    def _createGui(self):
        ...
        # Title
        titleLabel = wx.StaticText(self, -1, _("Title"))

        self._titleTextBox = wx.TextCtrl(self)
        self._titleTextBox.SetMinSize((250, -1))

        mainSizer.Add(titleLabel, flag=wx.ALIGN_CENTER_VERTICAL | wx.ALL, border=2)
        ...
        formatLabel = wx.StaticText(self, -1, _("Format"))

        self._formatCombo = wx.ComboBox(self, -1, style=wx.CB_DROPDOWN | wx.CB_READONLY)
        self._formatCombo.SetMinSize((250, -1))
        self._formatCombo.SetItems(self._formats)
        self._formatCombo.SetSelection(0)

        mainSizer.Add(formatLabel, flag=wx.ALIGN_CENTER_VERTICAL | wx.ALL, border=2)
        ...
        mainSizer.Add(okCancel, 1, wx.ALIGN_RIGHT | wx.ALIGN_BOTTOM | wx.ALL, border=4)
