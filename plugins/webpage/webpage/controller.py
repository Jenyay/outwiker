...
from .actions.downloadaction import CreateChildWebPageAction, CreateSiblingWebPageAction
...
class Controller:
    ...
    def initialize(self):
        ...
        self._application.onPageDialogPageFactoriesNeeded += (
            self._onPageDialogPageFactoriesNeeded
        )
    ...
    def _correctSysPath(self):
        cmd_folder = os.path.join(os.path.dirname(os.path.abspath(__file__)), "libs")
