...
<script type="text/javascript" src="./__attach/__thumb/jquery.fancybox.pack.js"></script>"""
        ...
        return u"""<script>  $(document).ready(function() {    $("a[href$='.jpg'],a[href$='.jpeg'],a[href$='.png'],a[href$='.PNG'],a[href$='.gif'],a[href$='.GIF'],a[href$='.bmp'],a[href$='.tif'],a[href$='.tiff']").attr('rel', 'gallery').fancybox();  });</script>"""
