...
class SpellCheckerTest (unittest.TestCase):
    ...
    def testEmpty_01 (self):
        ...
        checker = SpellChecker (self._application, ['ru_RU'], [])
    ...
    def testRu_01 (self):
        self._copyDict ('ru_RU')
        checker = SpellChecker (self._application, ['ru_RU'], [self._pathToDicts])
    ...
    def testInvalid_01 (self):
        ...
        SpellChecker (self._application, ['en-US-абырвалг'], [self._pathToDicts])


    def testRu_yo_01 (self):
        self._copyDict ('ru_YO')
        checker = SpellChecker (self._application, ['ru_YO'], [self._pathToDicts])
    ...
    def testRuEn_01 (self):
        ...
        checker = SpellChecker (self._application, ['ru_RU', 'en_US'], [self._pathToDicts])
        self.assertTrue (checker.check ('Проверка'))
    ...
    def testUserDict_01 (self):
        ...
        checker2 = SpellChecker (self._application, ['ru_RU'], [self._pathToDicts])
    ...
    def testUserDict_02 (self):
        ...
        checker3 = SpellChecker (self._application, ['ru_RU'], [self._pathToDicts])
