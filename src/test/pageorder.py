...
class PageOrderTest (unittest.TestCase):
    ...
    def testFirstPage (self):
        ...
        self.assertEqual (self.wikiroot.children[0], self.wikiroot[u"Страница 1"])
    ...
    def testCreateOrder1 (self):
        ...
        self.assertEqual (self.wikiroot.children[0], self.wikiroot[u"Страница 1"])
        self.assertEqual (self.wikiroot.children[1], self.wikiroot[u"Страница 2"])
    ...
    def testCreateOrder2 (self):
        ...
        self.assertEqual (self.wikiroot.children[0], self.wikiroot[u"Страница 1"])
        self.assertEqual (self.wikiroot.children[1], self.wikiroot[u"Страница 2"])
        self.assertEqual (self.wikiroot.children[2], self.wikiroot[u"Страница 3"])
    ...
    def testLoadingOldVersion1 (self):
        ...
        IntegerOption (self.wikiroot[u"Страница 0"].params, PageConfig.sectionName, PageConfig.orderParamName, -1).remove_option()
        IntegerOption (self.wikiroot[u"Страница 1"].params, PageConfig.sectionName, PageConfig.orderParamName, -1).remove_option()
        IntegerOption (self.wikiroot[u"Страница 2"].params, PageConfig.sectionName, PageConfig.orderParamName, -1).remove_option()
        IntegerOption (self.wikiroot[u"Страница 3"].params, PageConfig.sectionName, PageConfig.orderParamName, -1).remove_option()
