...
class IconsCollectionTest (unittest.TestCase):
    ...
    def testAddCover_01_group (self):
        ...
        newCoverPath = os.path.join (self.tempDir1, groupname, IconsCollection.COVER_FILE_NAME)
    ...
    def testAddCover_05_root (self):
        ...
        collection.setCover (None, coverpath, 0)
        self.assertTrue (os.path.exists (os.path.join (self.tempDir1, IconsCollection.COVER_FILE_NAME)))
        self.assertFalse (os.path.exists (os.path.join (self.tempDir2, IconsCollection.COVER_FILE_NAME)))


    def testAddCover_06_root (self):
        os.mkdir (self.tempDir1)
        os.mkdir (self.tempDir2)
        collection = IconsCollection ([self.tempDir1, self.tempDir2])
        ...
        collection.setCover (None, coverpath, -1)
        self.assertFalse (os.path.exists (os.path.join (self.tempDir1, IconsCollection.COVER_FILE_NAME)))
        self.assertTrue (os.path.exists (os.path.join (self.tempDir2, IconsCollection.COVER_FILE_NAME)))


    def testAddCover_07_root (self):
        os.mkdir (self.tempDir1)
        os.mkdir (self.tempDir2)
        collection = IconsCollection ([self.tempDir1, self.tempDir2])
    ...
    def testAddCover_09_group (self):
