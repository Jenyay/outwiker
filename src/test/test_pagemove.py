...
class MoveTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        factory.create(self.wiki, u"страница 4", [])
        factory.create(self.wiki, u"страница 444", [])
    ...
    def test2(self):
        ...
        self.assertEqual(self.wiki[u"Страница 2/Страница 3/Страница 1"].title,
                         u"Страница 1")
        self.assertEqual(
    ...
    def test4(self):
        ...
        self.assertTrue(os.path.exists(
            os.path.join(self.wiki[u"страница 444"].path,
                         u"страница 4")))
