...
class MovingActionTest (BaseMainWndTest):
    ...
    def test_goToParent_04 (self):
        self._createWikiPages()
        Application.wikiroot = self.wikiroot
        Application.selectedPage = self.wikiroot["Страница 1/Страница 1 - 1"]
        Application.actionController.getAction (GoToParentAction.stringId).run(None)
    ...
    def test_goToParent_05 (self):
        self._createWikiPages()
        Application.wikiroot = self.wikiroot
        Application.selectedPage = self.wikiroot["Страница 1/Страница 1 - 4"]
        Application.actionController.getAction (GoToParentAction.stringId).run(None)
        self.assertEqual (Application.selectedPage, self.wikiroot["Страница 1"])
    ...
    def test_goToParent_05 (self):
        self._createWikiPages()
        Application.wikiroot = self.wikiroot
        Application.selectedPage = self.wikiroot["Страница 1/Страница 1 - 4/Страница 1 - 4 - 1"]

        Application.actionController.getAction (GoToParentAction.stringId).run(None)
        self.assertEqual (Application.selectedPage, self.wikiroot["Страница 1/Страница 1 - 4"])
    ...
    def test_goToFirstChild_02 (self):
        ...
        Application.actionController.getAction (GoToFirstChildAction.stringId).run(None)
        self.assertEqual (Application.selectedPage, Application.wikiroot["Страница 1"])
    ...
    def test_goToFirstChild_03 (self):
        ...
        Application.actionController.getAction (GoToFirstChildAction.stringId).run(None)
        self.assertEqual (Application.selectedPage, Application.wikiroot["Страница 1/Страница 1 - 1"])
    ...
    def test_goToNextSibling_04 (self):
        ...
        Application.actionController.getAction (GoToNextSiblingAction.stringId).run(None)
        self.assertEqual (Application.selectedPage, self.wikiroot["Страница 3"])
    ...
    def test_goToNextSibling_05 (self):
        ...
        Application.actionController.getAction (GoToNextSiblingAction.stringId).run(None)
        self.assertEqual (Application.selectedPage, self.wikiroot["Страница 1/Страница 1 - 2"])

        Application.actionController.getAction (GoToNextSiblingAction.stringId).run(None)
        self.assertEqual (Application.selectedPage, self.wikiroot["Страница 1/Страница 1 - 3"])
    ...
    def test_goToNextSibling_06 (self):
        ...
        Application.actionController.getAction (GoToNextSiblingAction.stringId).run(None)
        self.assertEqual (Application.selectedPage, self.wikiroot["Страница 1/Страница 1 - 4/Страница 1 - 4 - 1"])
    ...
    def test_goToPrevSibling_04 (self):
        self._createWikiPages()
        Application.wikiroot = self.wikiroot
        Application.selectedPage = self.wikiroot["Страница 3"]
    ...
    def test_goToPrevSibling_05 (self):
        ...
        Application.actionController.getAction (GoToPrevSiblingAction.stringId).run(None)
        self.assertEqual (Application.selectedPage, self.wikiroot["Страница 1/Страница 1 - 1"])
