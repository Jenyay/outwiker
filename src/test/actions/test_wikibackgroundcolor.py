...
from outwiker.actions.polyactionsid import TEXT_BACKGROUND_COLOR_STR_ID
from outwiker.gui.tester import Tester


class WikiBackgroundColorActionTest(unittest.TestCase, BaseOutWikerGUIMixin):
    def setUp(self):
        self.initApplication()
        self.wikiroot = self.createWiki()
        self.actionController = self.application.actionController
        self.action = self.application.actionController.getAction(TEXT_BACKGROUND_COLOR_STR_ID)
...
%%'''
    ...
    def test_incapsulate_inline(self):
        ...
        result_right = 'Блок %bg-blue%текста%% бла-бла-бла'
        result = self.editor.GetText()
