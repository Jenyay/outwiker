...
class ParserUrlTest (unittest.TestCase):
    ...
    def testUrlParse28 (self):
        text = u"page://__adsfasdfaf"
        result = u'<a href="page://__adsfasdfaf">page://__adsfasdfaf</a>'

        self.assertEqual (self.parser.toHtml (text), result)


    def testUrlParse29 (self):
        text = u"page://__абырвалг-ффф"
        result = u'<a href="page://__абырвалг-ффф">page://__абырвалг-ффф</a>'
