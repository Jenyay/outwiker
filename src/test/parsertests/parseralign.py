...
class ParserAlignTest (unittest.TestCase):
    ...
    def testCenter1 (self):
        ...
        result = u'бла-бла-бла \n<div style="text-align:center">кхм бла-бла-бла\nбла-бла-бла</div>'
    ...
    def testCenter2 (self):
        text = u"бла-бла-бла \n%center%кхм бла-бла-бла\n\nбла-бла-бла"
        result = u'бла-бла-бла \n<div style="text-align:center">кхм бла-бла-бла</div>\n\nбла-бла-бла'
    ...
    def testCenter3 (self):
        ...
        result = u'<div style="text-align:center">бла-бла-бла \nкхм бла-бла-бла</div>\n\nбла-бла-бла'
    ...
    def testCenter5 (self):
        ...
        result = u'бла-бла-бла \n\n<div style="text-align:center"><img src="__attach/accept.png"/></div>\n\nбла-бла-бла\nбла-бла-бла'
    ...
    def testRight1 (self):
        ...
        result = u'бла-бла-бла \n<div style="text-align:right">кхм бла-бла-бла\nбла-бла-бла</div>'
    ...
    def testCommand1 (self):
        text = u"бла-бла-бла \n% right %(:command:)"
        result = u'бла-бла-бла \n<div style="text-align:right">(:command:)</div>'
    ...
    def testCommand2 (self):
        text = u"бла-бла-бла \n% right %(:command:)\nАбырвалг"
        result = u'бла-бла-бла \n<div style="text-align:right">(:command:)\nАбырвалг</div>'
    ...
    def testCommand3 (self):
        ...
        result = u'бла-бла-бла \n<div style="text-align:right">Абырвалг (:command:)\nАбырвалг</div>'
    ...
    def testCommand4 (self):
        ...
        result = u'бла-бла-бла \n<div style="text-align:right">(:command:) Абырвалг</div>'
    ...
    def testCommand6 (self):
        text = u"бла-бла-бла \n% right %(:command:)qqq\n\nwww\n(:commandend:) Абырвалг\n\n111"
        result = u'бла-бла-бла \n<div style="text-align:right">(:command:)qqq\n\nwww\n(:commandend:) Абырвалг</div>\n\n111'
    ...
    def testCommand7 (self):
        ...
        result = u'бла-бла-бла \n<div style="text-align:right">1111 (:command:)qqq\n\nwww\n(:commandend:) Абырвалг</div>\n\n111'
    ...
    def testCommand8 (self):
        ...
        result = u'бла-бла-бла \n<div style="text-align:right">1111 (:command:)111\n\n222(:commandend:) Абырвалг (:command2:)333\n\n\n444(:command2end:)</div>\n\n777'
    ...
    def testLeft1 (self):
        ...
        result = u'<div style="text-align:left">бла-бла-бла \n<b>кхм</b> бла-бла-бла</div>\n\nбла-бла-бла'
    ...
    def testJustify1 (self):
        ...
        result = u'<div style="text-align:justify">бла-бла-бла \n<b>кхм</b> бла-бла-бла</div>\n\nбла-бла-бла'
