...
class AboutDialog(wx.Dialog):
    def __init__(self, currversion, *args, **kwds):
        ...
        self.outwikerUrl = HyperLinkCtrl(self.aboutPane, -1, label=_("https://jenyay.net/Outwiker/English"), URL=_("https://jenyay.net/Outwiker/English"))
        ...
        self.facebook = HyperLinkCtrl(self.contactsPane, -1, label=_(u"Facebook page"), URL=_(u"https://www.facebook.com/outwiker"))
        self.livejournal = HyperLinkCtrl(self.contactsPane, -1, label=_(u"Livejournal community"), URL=_(u"https://ru-outwiker.livejournal.com/?style=mine"))
        self.twitter = HyperLinkCtrl(self.contactsPane, -1, label=_(u"Twitter"), URL=_(u"https://twitter.com/OutWiker"))
        self.vkontakte = HyperLinkCtrl(self.contactsPane, -1, label=_(u"Vkontakte group"), URL=_(u"https://vk.com/outwiker"))
