...
class StaticLineThemed(wx.StaticLine):
    def __init__(
        ...
        super(StaticLineThemed, self).__init__(
            parent, id=id, pos=pos, size=size, style=style
        )
    ...
    def SetTheme(self, theme: Optional[Theme]):
        ...
        if self._theme is not None:
            self._color = self._theme.get(
                Theme.SECTION_GENERAL, Theme.STATIC_LINE_COLOR
            )
