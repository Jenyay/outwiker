...
class UnknownPageTypePanel(BasePagePanel):
    ...
    def _createGUI(self):
        ...
        self._messageStaticText = wx.StaticText(
            self, label=message, style=wx.ALIGN_CENTER_HORIZONTAL
        )
        ...
        pageTypeSizer.Add(
            self._pageTypeStaticText, flag=wx.ALIGN_CENTER_VERTICAL | wx.ALL, border=4
        )
        pageTypeSizer.Add(self._pageTypeTextCtrl, flag=wx.ALIGN_LEFT | wx.ALL, border=4)
        ...
        sizer.Add(
            self._messageStaticText,
            flag=wx.ALIGN_CENTER | wx.ALIGN_CENTER_VERTICAL | wx.ALL,
            border=16,
        )

        sizer.Add(pageTypeSizer, flag=wx.ALIGN_CENTER_VERTICAL | wx.ALL, border=4)

        sizer.Add(
            self._contentStaticText,
            flag=wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL | wx.ALL,
            border=4,
        )

        sizer.Add(self._contentTextCtrl, flag=wx.EXPAND | wx.ALL, border=4)
