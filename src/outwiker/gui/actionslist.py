...
polyactionsList = [
    ...
    (polyactions.ITALIC_STR_ID, _("Italic"),
     _("Italic"), HotKey("I", ctrl=True)),
    (polyactions.BOLD_ITALIC_STR_ID, _("Bold italic"), _(
        u"Bold italic"), HotKey("I", ctrl=True, shift=True)),
    (polyactions.UNDERLINE_STR_ID, _("Underline"),
     _("Underline"), HotKey("U", ctrl=True)),
    (polyactions.STRIKE_STR_ID, _("Strikethrough"),
     _("Strikethrough"), HotKey("K", ctrl=True)),
    (polyactions.SUBSCRIPT_STR_ID, _("Subscript"),
     _("Subscript"), HotKey("=", ctrl=True)),
    (polyactions.SUPERSCRIPT_STR_ID, _("Superscript"),
     _("Superscript"), HotKey("+", ctrl=True)),
    (polyactions.PREFORMAT_STR_ID, _("Preformatted text"), _(
        u"Preformatted text"), HotKey("B", ctrl=True, shift=True)),
    (polyactions.CODE_STR_ID, _("Insert code"),
     _("Insert code(monospaced font)"), None),

    (polyactions.ALIGN_LEFT_STR_ID, _("Align text left"), _(
        u"Align text left"), HotKey("L", ctrl=True, shift=True)),
    (polyactions.ALIGN_CENTER_STR_ID, _("Align text center"),
     _("Center"), HotKey("C", ctrl=True, shift=True)),
    (polyactions.ALIGN_RIGHT_STR_ID, _("Align text right"), _(
        u"Align text right"), HotKey("R", ctrl=True, shift=True)),
    (polyactions.ALIGN_JUSTIFY_STR_ID, _("Justify"), _(
        u"Justify"), HotKey("J", ctrl=True, shift=True)),

    (polyactions.HEADING_1_STR_ID, _("First-level heading"),
     _("First-level heading"), HotKey("1", ctrl=True)),
    (polyactions.HEADING_2_STR_ID, _("Second-level heading"),
     _("Second-level heading"), HotKey("2", ctrl=True)),
    (polyactions.HEADING_3_STR_ID, _("Subtitle three"),
     _("Subtitle three"), HotKey("3", ctrl=True)),
    (polyactions.HEADING_4_STR_ID, _("Subtitle four"),
     _("Subtitle four"), HotKey("4", ctrl=True)),
    (polyactions.HEADING_5_STR_ID, _("Subtitle five"),
     _("Subtitle five"), HotKey("5", ctrl=True)),
    (polyactions.HEADING_6_STR_ID, _("Subtitle six"),
     _("Subtitle six"), HotKey("6", ctrl=True)),

    (polyactions.ANCHOR_STR_ID, _("Anchor"), _("Anchor"), None),
    (polyactions.HORLINE_STR_ID, _("Horizontal rule"), _(
        u"Horizontal rule"), HotKey("H", ctrl=True, shift=True)),
    (polyactions.LINK_STR_ID, _("Link"), _(
        u"Insert Link"), HotKey("L", ctrl=True)),
    (polyactions.QUOTE_STR_ID, _("Quote"), _(
        u"Insert a quote block"), HotKey("Q", ctrl=True)),
    (polyactions.IMAGE_STR_ID, _("Image"), _(
        u"Insert image"), HotKey("M", ctrl=True, shift=True)),
    (polyactions.MARK_STR_ID, _("Mark"), _("Mark text"), None),

    (polyactions.LIST_BULLETS_STR_ID, _("Bullets list"),
     _("Insert a bullets list"), HotKey("G", ctrl=True)),
    (polyactions.LIST_NUMBERS_STR_ID, _("Numbers list"),
     _("Insert a numbers list"), HotKey("J", ctrl=True)),

    (polyactions.LIST_DECREASE_LEVEL_STR_ID, _("Decrease nesting level"),
     _("Decrease the nesting level of the selected list items"), None),
    (polyactions.LINE_BREAK_STR_ID, _("Line break"), _(
        u"Insert a line break"), HotKey("Return", ctrl=True)),
    (polyactions.HTML_ESCAPE_STR_ID, _("Convert HTML Symbols"),
     _("Convert HTML Symbols"), None),

    (polyactions.TABLE_STR_ID, _("Table"), _(
        u"Insert a table"), HotKey("T", ctrl=True, shift=True)),
    (polyactions.TABLE_ROW_STR_ID, _("Table rows"), _(
        u"Insert table rows"), HotKey("G", ctrl=True, shift=True)),
    (polyactions.TABLE_CELL_STR_ID, _("Table cell"), _(
        u"Insert a table cell"), HotKey("U", ctrl=True, shift=True)),

    (polyactions.CURRENT_DATE, _("Current date"),
     _("Insert the current date"), None),
    (polyactions.SPELL_ON_OFF_ID, _("Spell checking"), _(
        u"Enable / disable spell checking"), HotKey("F7")),

    (polyactions.LINE_DUPLICATE_ID, _("Duplicate line"), _(
        u"Duplicate current line"), HotKey("D", ctrl=True, shift=True)),
    (polyactions.MOVE_SELECTED_LINES_UP_ID, _("Move selected lines up"),
     _("Move the selected lines up one line"), None),
    (polyactions.MOVE_SELECTED_LINES_DOWN_ID, _("Move selected lines down"),
     _("Move the selected lines down one line"), None),
    (polyactions.DELETE_CURRENT_LINE, _("Delete line"),
     _("Delete the current line"), None),
    (polyactions.JOIN_LINES, _("Join lines"), _("Join lines"), None),

    (polyactions.DELETE_WORD_LEFT, _("Delete word to the left"), _(
        u"Delete text to beginning of the word"), HotKey("Back", ctrl=True)),
    (polyactions.DELETE_WORD_RIGHT, _("Delete word to the right"), _(
        u"Delete text to ending of the word"), HotKey("Delete", ctrl=True)),
    (polyactions.DELETE_LINE_LEFT, _("Delete to start of the line"), _(
        u"Delete text back from the current position to the start of the line"), HotKey("Back", ctrl=True, shift=True)),
    (polyactions.DELETE_LINE_RIGHT, _("Delete to end of the line"), _(
        u"Delete text forwards from the current position to the end of the line"), HotKey("Delete", ctrl=True, shift=True)),

    (polyactions.GOTO_PREV_WORD, _("Go to previous word"), _(
        u"Move cursor to previous word"), HotKey("Left", ctrl=True)),
    (polyactions.GOTO_NEXT_WORD, _("Go to next word"), _(
        u"Move cursor to next word"), HotKey("Right", ctrl=True)),
    (polyactions.GOTO_PREV_WORD_SELECT, _("Go to previous word and select"), _(
        u"Move cursor to previous word and select text"), HotKey("Left", ctrl=True, shift=True)),
    (polyactions.GOTO_NEXT_WORD_SELECT, _("Go to next word and select"), _(
        u"Move cursor to next word and select text"), HotKey("Right", ctrl=True, shift=True)),
    (polyactions.GOTO_WORD_START, _("Go to start of the word"),
     _("Move cursor to start of the current word"), None),
    (polyactions.GOTO_WORD_END, _("Go to end of the word"),
     _("Move cursor to end of the current word"), None),

    (polyactions.CLIPBOARD_COPY_LINE, _("Copy line"),
     _("Copy the current line to clipboard"), None),
    (polyactions.CLIPBOARD_CUT_LINE, _("Cut line"),
     _("Cut the current line to clipboard"), None),
    (polyactions.CLIPBOARD_COPY_WORD, _("Copy word"),
     _("Copy the current word to clipboard"), None),
    (polyactions.CLIPBOARD_CUT_WORD, _("Cut word"),
     _("Cut the current word to clipboard"), None),
    (polyactions.TEXT_COLOR_STR_ID, _("Text color..."), _(
        u"Set text color"), HotKey("K", ctrl=True, shift=True)),
    (polyactions.TEXT_BACKGROUND_COLOR_STR_ID, _("Text background color..."),
     _("Set text background color"), HotKey("N", ctrl=True, shift=True)),
