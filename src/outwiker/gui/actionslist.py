...
actionsList = [
    ...
    (actions.openreadonly.OpenReadOnlyAction, HotKey("O", ctrl=True, shift=True)),
    ...
    (actions.addsiblingpage.AddSiblingPageAction, HotKey("T", ctrl=True, alt=True)),
    (actions.addchildpage.AddChildPageAction, HotKey("T", ctrl=True, shift=True)),
    ...
    (actions.attachfiles.AttachFilesAction, HotKey("A", ctrl=True, alt=True)),
    (actions.openattachfolder.OpenAttachFolderAction, HotKey("A", ctrl=True, shift=True, alt=True)),

    (actions.clipboard.CopyPageTitleAction, HotKey("D", ctrl=True, shift=True)),
    (actions.clipboard.CopyPagePathAction, HotKey("P", ctrl=True, shift=True)),
    (actions.clipboard.CopyAttachPathAction, HotKey("A", ctrl=True, shift=True)),
    (actions.clipboard.CopyPageLinkAction, HotKey("L", ctrl=True, shift=True)),
    ...
    (actions.reloadwiki.ReloadWikiAction, HotKey("R", ctrl=True)),
...
polyactionsList = [
    ...
    (polyactions.PREFORMAT_STR_ID, _(u"Preformatted text"), _(u"Preformatted text"), HotKey("F", ctrl=True, alt=True)),
    (polyactions.CODE_STR_ID, _(u"Insert code"), _(u"Insert code(monospaced font)"), HotKey("D", ctrl=True, alt=True)),
    (polyactions.ALIGN_LEFT_STR_ID, _(u"Align text left"), _(u"Align text left"), HotKey("L", ctrl=True, alt=True)),
    (polyactions.ALIGN_CENTER_STR_ID, _(u"Center"), _(u"Center"), HotKey("C", ctrl=True, alt=True)),
    (polyactions.ALIGN_RIGHT_STR_ID, _(u"Align text right"), _(u"Align text right"), HotKey("R", ctrl=True, alt=True)),
    (polyactions.ALIGN_JUSTIFY_STR_ID, _(u"Justify"), _(u"Justify"), HotKey("J", ctrl=True, alt=True)),
    ...
    (polyactions.ANCHOR_STR_ID, _(u"Anchor"), _(u"Anchor"), HotKey("N", ctrl=True, alt=True)),
    ...
    (polyactions.DELETE_CURRENT_LINE_ID, _(u"Delete line"), _(u"Delete the current line"), None),
    (polyactions.JOIN_LINES_STR_ID, _(u"Join lines"), _(u"Join lines"), None),
    (polyactions.DELETE_WORD_LEFT_STR_ID, _(u"Delete word to the left"), _(u"Delete text to beginning of the word"), HotKey("Back", ctrl=True)),
    (polyactions.DELETE_WORD_RIGHT_STR_ID, _(u"Delete word to the right"), _(u"Delete text to ending of the word"), HotKey("Delete", ctrl=True)),
    (polyactions.DELETE_LINE_LEFT_STR_ID, _(u"Delete to start of the line"), _(u"Delete text back from the current position to the start of the line"), HotKey("Back", ctrl=True, shift=True)),
    (polyactions.DELETE_LINE_RIGHT_STR_ID, _(u"Delete to end of the line"), _(u"Delete text forwards from the current position to the end of the line"), HotKey("Delete", ctrl=True, shift=True)),
