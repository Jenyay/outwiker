...
class XmlChangelogParser:
    ...
    @classmethod
    def _setChangelogVersions(
        cls, root: ElementTree.Element, changelog: "XmlChangeLog"
    ):
    ...
    @classmethod
    def _addDownloads(
        cls, tag_version: ElementTree.Element, downloads: "List[XmlDownload]"
    ):
