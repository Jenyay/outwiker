...
class CyHunspellWrapper (object):
        ...
        for lang in langlist:
            ...
            for path in dictsFinder.getFoldersForLang(lang):
                ...
                if (checker is None and
                    ...
                    checker = hunspell.Hunspell(lang, hunspell_data_dir=path, system_encoding='UTF-8')
                # else:
    ...
    def addCustomDict(self, customDictPath):
        ...
        try:
            ...
            checker = hunspell.Hunspell(dic_name, hunspell_data_dir=dic_folder, system_encoding='UTF-8')
