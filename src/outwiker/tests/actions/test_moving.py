...
class MovingActionTest(unittest.TestCase, BaseOutWikerGUIMixin):
    ...
    def test_goToParent_06(self):
        ...
        self.application.selectedPage = self.wikiroot[
            "Страница 1/Страница 1 - 4/Страница 1 - 4 - 1"
        ]
    ...
    def test_goToFirstChild_01(self):
        self.application.wikiroot = None
        self.application.actionController.getAction(GoToFirstChildAction.stringId).run(
            None
        )
        self.assertEqual(self.application.selectedPage, None)
    ...
    def test_goToFirstChild_02(self):
        ...
        self.assertEqual(
            self.application.selectedPage, self.application.wikiroot["Страница 1"]
        )
    ...
    def test_goToFirstChild_03(self):
        ...
        self.assertEqual(
            ...
            self.application.wikiroot["Страница 1/Страница 1 - 1"],
        )
    ...
    def test_goToNextSibling_01(self):
        self.application.wikiroot = None
        self.application.actionController.getAction(GoToNextSiblingAction.stringId).run(
            None
        )
        self.assertEqual(self.application.selectedPage, None)
    ...
    def test_goToNextSibling_05(self):
        ...
        self.assertEqual(
            self.application.selectedPage, self.wikiroot["Страница 1/Страница 1 - 2"]
        )
        ...
        self.assertEqual(
            self.application.selectedPage, self.wikiroot["Страница 1/Страница 1 - 3"]
        )
    ...
    def test_goToPrevSibling_01(self):
        self.application.wikiroot = None
        self.application.actionController.getAction(GoToPrevSiblingAction.stringId).run(
            None
        )
        self.assertEqual(self.application.selectedPage, None)
