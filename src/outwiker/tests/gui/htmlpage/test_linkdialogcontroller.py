...
class LinkDialogControllerHtmlTest(unittest.TestCase, BaseOutWikerGUIMixin):
    ...
    def testEmpty(self):
        ...
        controller = HtmlLinkDialogController(self._testpage, parent, selectedString)
    ...
    def testClipboardExitedPageLink(self):
        ...
        self.assertEqual(
            controller.linkResult,
            '<a href="page://{uid}">{title}</a>'.format(
    ...
    def testClipboardAnchor(self):
        ...
        self.assertEqual(controller.link, clipboardText)
        self.assertEqual(controller.comment, clipboardText)
        self.assertEqual(controller.linkResult, '<a href="#anchor">#anchor</a>')
    ...
    def testSelectedAttach(self):
        ...
        self.assertEqual(controller.comment, "{}/add.png".format(PAGE_ATTACH_DIR))
        self.assertEqual(
            controller.linkResult,
    ...
    def testSelectedAttach_subdir_back_slash(self):
        ...
        self.assertEqual(
            controller.link.replace("\\", "/"),
            "{}/subdir 1/subdir 2/add.png".format(PAGE_ATTACH_DIR),
        )
        self.assertEqual(controller.comment, selectedString)
        self.assertEqual(
            controller.linkResult,
            '<a href="{attach}/subdir 1/subdir 2/add.png">{attach}\\subdir 1\\subdir 2\\add.png</a>'.format(
                attach=PAGE_ATTACH_DIR
            ),
        )
