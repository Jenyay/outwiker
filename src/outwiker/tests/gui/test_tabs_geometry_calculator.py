...
def test_width_empty(calculator: TabsGeometryCalculator):
    text_height = 12
...
def test_width_single_line_max_width(calculator: TabsGeometryCalculator, tabs_count: int):
    text_height = 12
...
def test_width_single_line_small_width(calculator: TabsGeometryCalculator):
    tabs_count = 5
    text_height = 12
...
def test_width_two_rows(calculator: TabsGeometryCalculator):
    tabs_count = 3
    text_height = 12
    parent_width = 55
    tabs: List[TabInfo] = []
