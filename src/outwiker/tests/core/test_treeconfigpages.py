...
class ConfigPagesTest(unittest.TestCase):
    ...
    def testSetPageParams(self):
        param = StringOption(
            self.wikiroot["Страница 1"].params, "TestSection_1", "value1", ""
        )
        param.value = "Значение 1"
    ...
    def testSubwikiParams(self):
        ...
        wikiparam1 = StringOption(
            wiki["Страница 1"].params, "TestSection_1", "value1", ""
        )
        wikiparam2 = StringOption(
            wiki["Страница 1"].params, "TestSection_2", "value2", ""
        )
