...
class ReadonlyChangeTest(unittest.TestCase):
    ...
    def testMoveTo(self):
        self.assertRaises(
            ReadonlyException, self.wiki["Страница 1/Страница 5"].moveTo, self.wiki
        )
    ...
    def testSetParameter2(self):
        param = StringOption(
            self.wiki["Страница 2/Страница 3"].params, "section", "param", ""
        )
        param.value = "value"
    ...
    def testAttach1(self):
        ...
        self.assertRaises(
            ReadonlyException, Attachment(self.wiki["Страница 1"]).attach, fullFilesPath
        )
    ...
    def testAttach2(self):
        ...
        self.assertRaises(
            ReadonlyException,
            Attachment(self.wiki["Страница 2/Страница 3"]).attach,
            fullFilesPath,
        )
    ...
    def testChangeStyle1(self):
        ...
        self.assertRaises(
            ...
            style.setPageStyle,
            self.wiki["Страница 1"],
            self._exampleStyleDir,
        )

    def testChangeStyle2(self):
        style = Style()
        self.assertRaises(
            ReadonlyException, style.setPageStyleDefault, self.wiki["Страница 1"]
        )

    def testRemoveAttach1(self):
        self.assertRaises(
            ReadonlyException,
            Attachment(self.wiki["Страница 4"]).removeAttach,
            "add.png",
        )
    ...
    def testRemoveAttach2(self):
        self.assertRaises(
            ReadonlyException,
            Attachment(self.wiki["Страница 1/Страница 5"]).removeAttach,
            "anchor.png",
        )
    ...
    def testOrder1(self):
        self.assertRaises(
            ReadonlyException, self.__changeOrder, self.wiki["Страница 1"], 3
        )
