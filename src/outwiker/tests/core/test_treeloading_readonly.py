...
class ReadonlyChangeTest (unittest.TestCase):
    ...
    def testChangeIcon1 (self):
        self.assertRaises (ReadonlyException, self.__changeIcon, self.wiki["Страница 1"], "testdata/images/feed.gif")


    def testChangeIcon2 (self):
        self.assertRaises (ReadonlyException, self.__changeIcon, self.wiki["Страница 2/Страница 3"], "testdata/images/feed.gif")
