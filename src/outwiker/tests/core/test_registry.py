...
class RegistryTest(TestCase):
    ...
    def test_get_key_error_08(self):
        ...
        self.assertRaises(KeyError, reg.get, "раздел-1", "раздел-2", default=10)
    ...
    def test_get_default_02(self):
        ...
        reg = Registry(items)
        self.assertEqual(reg.get("раздел-1", "раздел-2", "параметр", default=10), 1)
    ...
    def test_get_default_03(self):
        ...
        reg = Registry(items)
        self.assertEqual(reg.get("раздел-1", "раздел-2", "параметр", default=10), 10)
    ...
    def test_get_str_02(self):
        items = {}
        reg = Registry(items)
        self.assertEqual(reg.getstr("параметр", default="абырвалг"), "абырвалг")
    ...
    def test_remove_section_error_04(self):
        ...
        self.assertRaises(
            KeyError, reg.remove_section, "раздел-1", "раздел-2", "параметр"
        )
