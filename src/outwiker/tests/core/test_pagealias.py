...
class PageAliasTest(unittest.TestCase):
    ...
    def test_alias_readonly_02(self):
        ...
        self.assertRaises(ReadonlyException, self._changeAlias, page, None)
    ...
    def test_alias_readonly_03(self):
        ...
        self.assertRaises(ReadonlyException, self._changeAlias, page, "")
    ...
    def test_alias_readonly_04(self):
        ...
        self.assertRaises(ReadonlyException, self._changeAlias, page, "test")
