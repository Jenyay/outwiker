...
from outwiker.core.defines import ICONS_STD_PREFIX, PAGE_ICON_NAME, ICONS_EXTENSIONS
from outwiker.core.exceptions import ReadonlyException
from outwiker.core.iconcontroller import IconController
from outwiker.pages.text.textpage import TextPageFactory

from outwiker.tests.utils import createFile, removeDir
...
class IconControllerTest(unittest.TestCase):
    ...
    def test_set_icon_custom_png(self):
        ...
        self.assertTrue(
            os.path.exists(os.path.join(self._page.path, PAGE_ICON_NAME + ".png"))
        )
    ...
    def test_set_icon_custom_gif(self):
        ...
        self.assertTrue(
            os.path.exists(os.path.join(self._page.path, PAGE_ICON_NAME + ".gif"))
        )
    ...
    def test_set_icon_custom_bmp(self):
        ...
        self.assertTrue(
            os.path.exists(os.path.join(self._page.path, PAGE_ICON_NAME + ".bmp"))
        )
    ...
    def test_set_icon_custom_jpg(self):
        ...
        self.assertTrue(
            os.path.exists(os.path.join(self._page.path, PAGE_ICON_NAME + ".jpg"))
        )
    ...
    def test_set_icon_custom_jpeg(self):
        ...
        self.assertTrue(
            os.path.exists(os.path.join(self._page.path, PAGE_ICON_NAME + ".jpeg"))
        )
    ...
    def test_set_icon_custom_ico(self):
        ...
        self.assertTrue(
            os.path.exists(os.path.join(self._page.path, PAGE_ICON_NAME + ".ico"))
        )
    ...
    def test_set_icon_custom_svg(self):
        ...
        self.assertTrue(
            os.path.exists(os.path.join(self._page.path, PAGE_ICON_NAME + ".svg"))
        )
