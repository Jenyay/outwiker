...
class PackageCheckVersionTest(unittest.TestCase):
    def test_equal(self):
        ...
        required = (1, 1)
        self.assertEqual(
            pv.checkSingleVersion(current_api_version, required), pv.VERSION_OK
        )
    ...
    def test_less_minor(self):
        ...
        required = (1, 10)
        self.assertEqual(
            pv.checkSingleVersion(current_api_version, required),
...
class PackageCheckVersionAnyTest(unittest.TestCase):
    def test_ok_empty(self):
        current_api_version = (1, 1)
        required = []
        self.assertEqual(pv.checkVersion(current_api_version, required), pv.VERSION_OK)
    ...
    def test_fail_01(self):
        ...
        required = [(1, 1), (3, 0)]
        self.assertNotEqual(
            pv.checkVersion(current_api_version, required), pv.VERSION_OK
        )
    ...
    def test_fail_02(self):
        ...
        required = [(2, 15)]
        self.assertEqual(
            pv.checkVersion(current_api_version, required), pv.OUTWIKER_MUST_BE_UPGRADED
        )
    ...
    def test_fail_03(self):
        ...
        required = [(1, 0)]
        self.assertEqual(
            pv.checkVersion(current_api_version, required), pv.PLUGIN_MUST_BE_UPGRADED
        )
