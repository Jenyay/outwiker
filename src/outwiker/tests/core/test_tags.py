...
class TagsListTest(unittest.TestCase):
    ...
    def testAppendTagsList(self):
        appendTagsList(
            self.wikiroot["Страница 2"], ["Метка 111", "Метка 222", "Метка 333"]
        )
    ...
    def testTagBranch(self):
        ...
        self.assertEqual(len(self.wikiroot["Страница 2/Страница 3/Страница 4"].tags), 3)

        self.assertIn("Метка 111".lower(), self.wikiroot["Страница 2"].tags)
        self.assertIn("Метка 111".lower(), self.wikiroot["Страница 2/Страница 3"].tags)
        self.assertIn(
            "Метка 111".lower(), self.wikiroot["Страница 2/Страница 3/Страница 4"].tags
        )

        self.assertIn("Метка 222".lower(), self.wikiroot["Страница 2"].tags)
        self.assertIn("Метка 222".lower(), self.wikiroot["Страница 2/Страница 3"].tags)
        self.assertIn(
            "Метка 222".lower(), self.wikiroot["Страница 2/Страница 3/Страница 4"].tags
        )
    ...
    def testTagRoot(self):
        ...
        self.assertIn("Метка 222".lower(), self.wikiroot["page 1/page 5"].tags)
    ...
    def testAppendExists(self):
        ...
        self.assertNotIn("Метка 1".lower(), self.wikiroot["Страница 2"].tags)
    ...
    def testRemoveTagsFromBranch1(self):
        ...
        self.assertEqual(len(self.wikiroot["Страница 2/Страница 3/Страница 4"].tags), 0)
    ...
    def testRemoveTagsFromBranch2(self):
        removeTagsFromBranch(self.wikiroot["Страница 2"], ["МеТкА 1", "Метка 1000"])
    ...
    def testRemoveTagsEmpty(self):
        ...
        self.assertEqual(len(self.wikiroot["Страница 2/Страница 3"].tags), 1)
        self.assertEqual(len(self.wikiroot["Страница 2/Страница 3/Страница 4"].tags), 1)
    ...
    def testRenameTag(self):
        ...
        self.assertIn(
            self.wikiroot["Страница 2/Страница 3/Страница 4"], tags["Черная метка"]
        )
