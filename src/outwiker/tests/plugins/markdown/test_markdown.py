...
<li>Строка 3</li>
    ...
    def test_link_01(self):
        ...
        right_result = (
            """<a href="http://example.com/" title="Заголовок">Пример ссылки</a>"""
        )
        result = self.__getHtmlByText(text)
        self.assertIn(right_result, result)
...
"""
        ...
        right_result = (
            """<a href="http://example.com/" title="Заголовок">идентификатор</a>"""
        )
        result = self.__getHtmlByText(text)
        self.assertIn(right_result, result)
...
"""
    ...
    def test_image_02(self):
        ...
        right_result = (
            """<img alt="Текст" src="__attach/basket.png" title="Заголовок">"""
        )
        result = self.__getHtmlByText(text)
        self.assertIn(right_result, result)
...
[id]: __attach/camera.png  "Заголовок"'''
        ...
        right_result = (
            """<img alt="Alt text" src="__attach/camera.png" title="Заголовок">"""
        )
        result = self.__getHtmlByText(text)
        self.assertIn(right_result, result)
