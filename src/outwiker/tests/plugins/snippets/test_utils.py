...
class SnippetsUtilsTest(unittest.TestCase, BaseOutWikerGUIMixin):
    ...
    def test_findUniquePath_03(self):
        ...
        uniquePath = findUniquePath(self._tmpdir, fname)
        self.assertEqual(uniquePath, os.path.join(self._tmpdir, fname + " (1)"))
    ...
    def test_findUniquePath_04(self):
        ...
        uniquePath = findUniquePath(self._tmpdir, fname)
        self.assertEqual(uniquePath, os.path.join(self._tmpdir, fname + " (3)"))
    ...
    def test_findUniquePath_06(self):
        ...
        uniquePath = findUniquePath(self._tmpdir, fname, ".txt")
        self.assertEqual(uniquePath, os.path.join(self._tmpdir, "Имя файла (1).txt"))
    ...
    def test_findUniquePath_07(self):
        ...
        uniquePath = findUniquePath(self._tmpdir, fname, ".txt")
        self.assertEqual(uniquePath, os.path.join(self._tmpdir, "Имя файла (3).txt"))
    ...
    def test_findUniquePath_08(self):
        ...
        self.assertEqual(
            uniquePath, os.path.join(self._tmpdir, "Имя файла.txt (1).dat")
        )
