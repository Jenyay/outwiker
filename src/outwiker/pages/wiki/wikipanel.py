...
class WikiPagePanel (BaseHtmlPanel):
    ...
    def __createCustomTools (self):
        ...
        self.__wikiMenu.AppendSubMenu (self.__formatMenu, _(u"Fo&rmatting"))
        self.__wikiMenu.AppendSubMenu (self.__listMenu, _(u"&Lists"))
        self.__wikiMenu.AppendSubMenu (self.__commandsMenu, _(u"Co&mmands"))
