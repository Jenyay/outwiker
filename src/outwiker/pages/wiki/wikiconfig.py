...
class WikiConfig:
    ...
    def __init__(self, config):
        ...
        self.showHtmlCodeOptions = BooleanOption(
            self.config, WikiConfig.WIKI_SECTION, WikiConfig.SHOW_HTML_CODE_PARAM, True
        )

        # Размер превьюшек по умолчанию
        self.thumbSizeOptions = IntegerOption(
            self.config,
        ...
        self.linkStyleOptions = IntegerOption(
            self.config,
            WikiConfig.WIKI_SECTION,
        ...
        self.attachment = StcStyleOption(
            self.config,
            WikiConfig.STYLES_SECTION,
        ...
        self.colorizeSyntax = BooleanOption(
            self.config,
            self.WIKI_SECTION,
        ...
        self.recentStyleName = StringOption(
            self.config,
            self.WIKI_SECTION,
