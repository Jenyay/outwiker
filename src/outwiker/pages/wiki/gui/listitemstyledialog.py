...
class ListItemStyleDialog(TestedDialog):
    def __init__(self, parent: wx.Window):
        ...
        self._styles_list.Bind(
            wx.EVT_LIST_ITEM_ACTIVATED, handler=self._onItemActivated
        )
    ...
    def _create_gui(self):
        ...
        main_sizer.Add(self._styles_list, flag=wx.ALL | wx.EXPAND, border=2)
        main_sizer.Add(
...
class ListItemStyleDialogController:
    def __init__(self, dialog: ListItemStyleDialog):
        ...
        self._image_list = SafeImageList(
            self._width, self._height, dialog.GetDPIScaleFactor()
        )
