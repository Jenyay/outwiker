...
Для получения исходного кода OutWiker вам понадобится git_. Также должны быть установлены `Python 2.7 <https://www.python.org/>` (в данный момент Python 3.x не поддерживается) и pip_.
