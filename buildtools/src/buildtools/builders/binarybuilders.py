...
class BaseBinaryBuilder(metaclass=ABCMeta):
    ...
    def get_includes(self):
        ...
        return [
            ...
            'outwiker.api.gui.dialogs.baselinkdialogcontroller',
            ...
            'outwiker.api.services.bookmarks',
            'outwiker.api.services.clipboard',
            'outwiker.api.services.messages',
            'outwiker.api.services.texteditor',
            'outwiker.api.services.tree',
            'outwiker.api.pages',
            'outwiker.api.pages.wiki',
            'outwiker.api.pages.wiki.parser',
            'outwiker.api.pages.wiki.defines',
            'outwiker.api.pages.wiki.parser.command',
